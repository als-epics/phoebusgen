...
class TestImage(unittest.TestCase, ph.TestPVName, ph.TestForegroundColor, ph.TestBackgroundColor,
                ...
                ph.TestYAxisSingle, ph.TestColorMode, ph.TestRegionsOfInterest, ph.TestColorBar, ph.TestColorMap):
    def setUp(self):
        self.name = 'my data browser'
        ...
        self.map1 = widgets.ColorMapColor(0, 1, 2, 3)
        self.map2 = widgets.ColorMapColor(255, 4, 5, 6)
        self.map3 = widgets.ColorMapColor(100, 7, 8, 9)
...
class TestXYPlot(unittest.TestCase, ph.TestForegroundColor, ph.TestBackgroundColor,
                ...
                ph.TestYAxes, ph.TestXAxes, ph.TestMarkers):
    def setUp(self):
        self.name = 'xyxyxyxyx'
        self.type = 'xyplot'
        self.x = 24
        ...
        self.marker1 = widgets.Marker()
        self.marker2 = widgets.Marker()
...
class TestROI(unittest.TestCase, ph.TestName, ph.TestColor, ph.TestInteractive, ph.TestXPV, ph.TestYPV, ph.TestWidthPV,
