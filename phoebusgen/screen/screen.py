...
class Screen(object):
    ...
    def __init__(self, name: str, f_name: str = None) -> None:
        ...
        :param name: <str> Screen Name
        :param f_name: <str> File name for Phoebus screen
        """
    ...
    def write_screen(self, file_name: str = None) -> bool:
        ...
        :param file_name: <str> File name to write to
        :return: <bool> True is successful write, False otherwise
        """
    ...
    def find_widget(self, widget_tag_name: str) -> Element:
        ...
        :param widget_tag_name: <str> Tag name of widget to find
